...
const sortPeopleBetter = (people) => {
  // Solution code here...
  return people.sort((a, b) => a.lastName === b.lastName && a.firstName === b.firstName ? a.age - b.age : a.lastName === a.lastName ? a.firstName > b.firstName : a.lastName - b.lastName);
};
...
const sortMeetingsByDay = (meetings) => {
  // Solution code here...
  return meetings.sort((a, b) => a.dayOfWeek === b.dayOfWeek ? 0 : a.dayOfWeek - b.dayOfWeek); 
};
