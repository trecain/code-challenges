...
const extractStat = (statName, input) => {
  // Solution code here...
  return input.reduce((accumulator, currentValue) => currentValue.name === statName ? currentValue : accumulator);
};
...
const calculateAverage = (input) => {
  // Solution code here...
  return input.reduce((accumulator, currentValue) => accumulator += currentValue) / input.length;
};
